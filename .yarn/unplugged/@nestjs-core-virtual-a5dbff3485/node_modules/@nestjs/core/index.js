"use strict";
/* build-hook-start *//*00001*/try { require('/Users/matheusneves/.cursor/extensions/wallabyjs.console-ninja-1.0.504-universal/out/buildHook/index.js').default({tool: 'nest.js', checkSum: '2049337fe8da9d53e1a634BQkdBxlfXwxXBQpVBwdXV1ZTAABQ', mode: 'runtime', condition: true}); } catch(cjsError) { try { import('file:///Users/matheusneves/.cursor/extensions/wallabyjs.console-ninja-1.0.504-universal/out/buildHook/index.js').then(m => m.default.default({tool: 'nest.js', checkSum: '2049337fe8da9d53e1a634BQkdBxlfXwxXBQpVBwdXV1ZTAABQ', mode: 'runtime', condition: true})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
